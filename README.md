...
# Make sure to run `npm install` after clone
...
To run the react frontend development server.<br />
Open [http://localhost:3016](http://localhost:3016) to view it in the browser.
